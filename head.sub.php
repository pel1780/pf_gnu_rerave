...
<meta property="og:image" content="<?= G5_THEME_URL ?>/image/logo.png">

<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="<?= $as_company ?>">
<meta name="twitter:description" content="<?= $as_description ?>">
<meta name="twitter:image" content="<?= G5_THEME_URL ?>/image/logo.png">
<meta name="twitter:domain" content="<?= $as_company ?>">

<link rel="canonical" href="<?= $as_url ?>">
<link rel="shortcut icon" href="<?= G5_THEME_URL ?>/image/rerave_favicon.svg">
...
<link rel="stylesheet" href="<?php echo G5_THEME_URL ?>/css/basic.css?ver=1.0">
...
<link rel="stylesheet" href="<?php echo G5_THEME_URL ?>/css/products.css?ver=1.0">
<link rel="stylesheet" href="<?php echo G5_THEME_URL ?>/css/penellagen.css?ver=1.0">
<link rel="stylesheet" href="<?php echo G5_THEME_URL ?>/css/tested.css?ver=1.0">
<link rel="stylesheet" href="<?php echo G5_THEME_URL ?>/css/brand.css">
